    ...
    <main>
        ...
        <div class="slider-area hero-bg1   hero-overly">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="https://picsum.photos/800/350" class="d-block w-100" alt="https://picsum.photos/800/350">
                  </div>
            ...
            {{-- <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="https://picsum.photos/500/250" class="d-block w-100" alt="https://picsum.photos/500/250">
                  </div>
                  <div class="carousel-item">
                    <img src="https://picsum.photos/500/250" class="d-block w-100" alt="https://picsum.photos/500/250">
                  </div>
                    ...
                    <div class="row justify-content-start ">
                        <div class="col-xl-7 col-lg-11">
                            ...
                            {{-- <div class="hero-caption pt-10">
                                ...
                                <p>Search deals on Hotels Taxi and much morehttps://picsum.photos/500/250</p>
                            </div> --}}
                        </div>
                    </div>
                </div>
